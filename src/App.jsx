...
@media(max-width:900px){
  ...
  .hero-name{font-size:clamp(2.8rem,10vw,5rem)!important;white-space:normal!important}
  .hero-desc{font-size:.95rem}
  .ctr{padding:0 1.2rem}
  .icard,.int-box{padding:1rem}
  #hero{padding-top:5rem!important;padding-bottom:2rem!important}
  #about,#skills,#experience,#projects,#system-design,#ai-experiments,#leadership,#achievements,#contact{padding:3rem 0!important}
  .exp-card{padding:1.2rem}
  .pbody,.pcard.full .pbody{padding:1.2rem}
  .pcb,.pcard.full .pcb{padding:1.5rem}
  .awards-grid{grid-template-columns:1fr}
  .lead-grid{grid-template-columns:1fr}
  .ai-grid{grid-template-columns:1fr}
  .sg-grid{grid-template-columns:1fr}
  .contact-inner{padding:0 .5rem}
  .cc-grid{grid-template-columns:1fr 1fr!important;gap:.75rem}
  .ttl{font-size:clamp(1.6rem,6vw,2.8rem)!important}
  .hero-btns{gap:.6rem}
  .btn-p,.btn-s{padding:.65rem 1.1rem;font-size:.82rem}
}
  ...
  return (
    <nav className={slim ? "slim" : ""}>
      ...
      <ul className="nav-links">
        {[["about","About"],["skills","Skills"],["experience","Experience"],["projects","Projects"],["system-design","Design"],["ai-experiments","AI"],["leadership","Leadership"],["achievements","Achievements"],["contact","Contact"]].map(([id,label]) => (
    ...
    <section id="hero" style={{ minHeight:"100vh", display:"flex", alignItems:"center", paddingTop:"5rem" }}>
      <div className="ctr" style={{ width:"100%" }}>
        <div className="hero-inner">
          <div className="fade">
            {/* Mobile photo */}
            <div className="hero-photo-mobile" style={{display:"none",justifyContent:"center",marginBottom:"1.5rem"}}>
